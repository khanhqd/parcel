    ...
    renderOption(option) {
        return (
            <TouchableOpacity key={option.key} onPress={()=>this.onChange(option)}>
                <View style={[styles.optionStyle, this.props.optionStyle,{height: 40}]}>
                    <Text style={[styles.optionTextStyle,this.props.optionTextStyle,{color: 'black'}]}>{option.label}</Text>
                </View>
            </TouchableOpacity>)
    }
